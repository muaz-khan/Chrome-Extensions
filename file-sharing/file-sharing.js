...
function setupWebRTCConnection() {
    ...
    connection.openOrJoin(connection.channel, function(isRoomExists) {
        ...
        document.querySelector('h1').innerHTML = '<a href="https://rtcmulticonnection.herokuapp.com/demos/file-sharing.html#' + room_id + '" target="_blank">Private Room URL: #' + room_id + '</a>';
    });
